...
def opendocx(file, fileType='body'):
	# This function was updated by Iyad Obeid from the original
	# version on GitHub
	...
	if fileType == 'hdr1':
		...
		xmlcontent = mydoc.read('word/header3.xml')
	elif fileType == 'body':
		xmlcontent = mydoc.read('word/document.xml')
	elif fileType == 'ftr1':
		xmlcontent = mydoc.read('word/footer1.xml')
	elif fileType == 'ftr2':
		xmlcontent = mydoc.read('word/footer2.xml')
	elif fileType == 'ftr3':
		xmlcontent = mydoc.read('word/footer3.xml')
